...
Supply assets to a lending pool and receive jTokens (supply shares).
...
Borrow without collateral. The loan must repaid within the same transaction. Follows ERC-3156 standard.
