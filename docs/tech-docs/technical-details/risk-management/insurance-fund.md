...
* _Rs_: supply rate
* _Rb_: borrow rate
* _U_: utilization ratio
* _t_: take rate (fraction of borrower interest diverted as the take rate before reaching lenders)
...
* _LTV_: loan-to-value ratio of the obligation
