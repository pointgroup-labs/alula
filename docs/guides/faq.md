...
<summary>Why won’t my wallet connect, or why does it keep disconnecting?</summary>
...
<summary>What should I do if a transaction is pending for a long time or fails after I sign it?</summary>
...
<summary>What happens if I don’t have enough XLM to pay network fees?</summary>
...
<summary>Why can’t I supply or borrow more even when I have balance and the market shows liquidity?</summary>
...
<summary>Why is an asset marked Restricted, and what does it mean for me?</summary>
...
<summary>Why can’t I borrow in the same pool where I have a deposit (or supply to a pool where I have an active loan)?</summary>
...
<summary>Why can’t I supply or borrow more even when I have balance (caps, pauses, or limits)?</summary>

This happens when any of these apply: pool caps (like Supply Limit), market status pauses (deposit/borrow frozen), borrow-side liquidity constraints, or account-side limits such as borrowing capacity and health-factor requirements.

</details>

<details>

<summary>Why does a withdrawal get blocked even when I’m not trying to take out “too much”?</summary>
...
<summary>Why does Multiply show a negative APY sometimes?</summary>
