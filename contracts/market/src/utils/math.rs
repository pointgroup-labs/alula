...
mod tests {
    ...
    fn test_bin_pow_integer_powers() {
        ...
        for (base, exponent, denominator, expected) in test_cases {
            ...
            assert_eq!(result, expected, "Base {}, Exponent {}, Denominator {}", base, exponent, denominator);
        }
    }
    ...
    fn test_bin_pow_identity_base() {
        ...
        for &denominator in &denominators {
            for exponent in [0, 1, 2, 10, 50, 100] {
                ...
                assert_eq!(result, denominator, "Denominator {}, Exponent {}", denominator, exponent);
            }
        }
    }
