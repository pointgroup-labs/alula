...
declare global {
  ...
  const client: typeof import('../store/client')['client']
  ...
  const findMatchingAsset: typeof import('../store/wallet')['findMatchingAsset']
  ...
  const useConnection: typeof import('../hooks/connection')['useConnection']
