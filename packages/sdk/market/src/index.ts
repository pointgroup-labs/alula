...
export interface ModErc3156FlashLoanRequest {
  amount: i128
  contract: string
  pool_address: string
}
...
export type Request = { tag: 'Deposit', values: readonly [StandardRequest] } | { tag: 'Borrow', values: readonly [StandardRequest] } | { tag: 'Withdraw', values: readonly [StandardRequest] } | { tag: 'Repay', values: readonly [StandardRequest] } | { tag: 'AddCollateral', values: readonly [StandardRequest] } | { tag: 'RemoveCollateral', values: readonly [StandardRequest] } | { tag: 'FlashBorrow', values: readonly [StandardRequest] } | { tag: 'SwapExactTokens', values: readonly [SwapExactTokensRequest] } | { tag: 'SwapForExactTokens', values: readonly [SwapForExactTokensRequest] } | { tag: 'Liquidate', values: readonly [LiquidateRequest] } | { tag: 'ModErc3156FlashLoan', values: readonly [ModErc3156FlashLoanRequest] }
...
export interface Client {
   ...
   */
  submit_requests_batch: ({ obligation_key, requests, referrer}: { obligation_key: ObligationKey, requests: Array<Request>, referrer: Option<string> }, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  /**
   * Construct and simulate a update_swap_provider transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  update_swap_provider: ({ new_swap_provider}: { new_swap_provider: string }, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  initialize_pool: ({ token_address, pool_config}: { token_address: string, pool_config: Option<PoolConfig> }, options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
    ...
    { name, admin, oracle, swap_provider, insurance_fund, deployer, max_positions, min_collateral_value_cents, insolvency_ltv_bps, update_in_queue_period}: { name: string, admin: string, oracle: string, swap_provider: string, insurance_fund: string, deployer: string, max_positions: u32, min_collateral_value_cents: i128, insolvency_ltv_bps: i128, update_in_queue_period: Option<u64> },
    ...
    return ContractClient.deploy({ name, admin, oracle, swap_provider, insurance_fund, deployer, max_positions, min_collateral_value_cents, insolvency_ltv_bps, update_in_queue_period }, options)
  }
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec(['AAAAAgAAAAAAAAAAAAAADEFjY3J1YWxNb2RlbAAAAAEAAAAAAAAAAAAAAApDb21wb3VuZGVkAAA=',
        ...
        'AAAAAAAAAAAAAAAVc3VibWl0X3JlcXVlc3RzX2JhdGNoAAAAAAAAAwAAAAAAAAAOb2JsaWdhdGlvbl9rZXkAAAAAB9AAAAANT2JsaWdhdGlvbktleQAAAAAAAAAAAAAIcmVxdWVzdHMAAAPqAAAH0AAAAAdSZXF1ZXN0AAAAAAAAAAAIcmVmZXJyZXIAAAPoAAAAEwAAAAEAAAPpAAAD7QAAAAAAAAfQAAAAB01DRXJyb3IA',
        'AAAAAAAAAAAAAAAQZ2V0X2dsb2JhbF9zdGF0ZQAAAAAAAAABAAAH0AAAAAtHbG9iYWxTdGF0ZQA=',
        'AAAAAAAAAAAAAAAUdXBkYXRlX3N3YXBfcHJvdmlkZXIAAAABAAAAAAAAABFuZXdfc3dhcF9wcm92aWRlcgAAAAAAABMAAAAA',
        ...
        'AAAAAAAAAAAAAAAPaW5pdGlhbGl6ZV9wb29sAAAAAAIAAAAAAAAADXRva2VuX2FkZHJlc3MAAAAAAAATAAAAAAAAAAtwb29sX2NvbmZpZwAAAAPoAAAH0AAAAApQb29sQ29uZmlnAAAAAAABAAAD6QAAABMAAAfQAAAAB01DRXJyb3IA',
        ...
        '',
        ...
        '',
        ...
        '',
        '',
        ...
        'AAAABQAAAAAAAAAAAAAADFVwZGF0ZU1hcmtldAAAAAEAAAANdXBkYXRlX21hcmtldAAAAAAAAAIAAAAAAAAAEW5ld19tYXhfcG9zaXRpb25zAAAAAAAABAAAAAAAAAAAAAAAHm5ld19taW5fY29sbGF0ZXJhbF92YWx1ZV9jZW50cwAAAAAACwAAAAAAAAAC',
        ...
        '',
        ...
        'AAAAAQAAAAAAAAAAAAAAGk1vZEVyYzMxNTZGbGFzaExvYW5SZXF1ZXN0AAAAAAADAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAACGNvbnRyYWN0AAAAEwAAAAAAAAAMcG9vbF9hZGRyZXNzAAAAEw==',
        'AAAAAQAAAAAAAAAAAAAAFlN3YXBFeGFjdFRva2Vuc1JlcXVlc3QAAAAAAAUAAAAAAAAACWFtb3VudF9pbgAAAAAAAAsAAAAAAAAADm1pbl9hbW91bnRfb3V0AAAAAAALAAAAAAAAAA1zd2FwX3Byb3ZpZGVyAAAAAAAAEwAAAAAAAAAIdG9rZW5faW4AAAATAAAAAAAAAAl0b2tlbl9vdXQAAAAAAAAT',
        'AAAAAQAAAAAAAAAAAAAAGVN3YXBGb3JFeGFjdFRva2Vuc1JlcXVlc3QAAAAAAAAFAAAAAAAAAAphbW91bnRfb3V0AAAAAAALAAAAAAAAAA1tYXhfYW1vdW50X2luAAAAAAAACwAAAAAAAAANc3dhcF9wcm92aWRlcgAAAAAAABMAAAAAAAAACHRva2VuX2luAAAAEwAAAAAAAAAJdG9rZW5fb3V0AAAAAAAAEw==',
        ...
        '',
        '',
        ...
        '',
  ...
  public readonly fromJSON = {
    ...
    update_swap_provider: this.txFromJSON<null>,
