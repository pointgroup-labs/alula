...
export interface Client {
  ...
  /**
   * Construct and simulate a collect_dust transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  collect_dust: (options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec(['AAAAAgAAAAAAAAAAAAAADEFjY3J1YWxNb2RlbAAAAAEAAAAAAAAAAAAAAApDb21wb3VuZGVkAAA=',
        ...
        'AAAAAAAAAAAAAAAMY29sbGVjdF9kdXN0AAAAAAAAAAEAAAPpAAAD7QAAAAAAAAfQAAAAB01DRXJyb3IA',
  ...
  public readonly fromJSON = {
    ...
    collect_dust: this.txFromJSON<Result<void>>,
  }
}
