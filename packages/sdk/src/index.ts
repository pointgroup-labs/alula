...
export type DataKey = { tag: 'GlobalState', values: void } | { tag: 'Pool', values: readonly [Address] } | { tag: 'Obligation', values: readonly [Address] } | { tag: 'MultiplyPair', values: readonly [readonly [Address, Address]] } | { tag: 'Accrual', values: void } | { tag: 'AllPools', values: void } | { tag: 'AllObligations', values: void } | { tag: 'AllMultiplyPairs', values: void }
